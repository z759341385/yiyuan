...
export default class extends Vue {
  menus = [
    ...
    { title: "输液监控", icon: "hos-shuye", page: "Infusion", path: "/infusion" },
    ...
    { title: "工作动态", icon: "hos-gongzuotai", page: "Workshop", path: "/workshop" },
    { title: "心语苑", icon: "hos-dingyue", page: "DepartmentInfo", path: "/departmentInfo" },
