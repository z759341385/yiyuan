  ...
  ([
    ...
    (function (module, exports, __webpack_require__) {
      ...
      if (Component.options.functional) {
        console.error("[vue-loader] progress-bar.vue: functional components are not supported with templates, they should use render functions.")
      }
    ...
    (function (module, exports, __webpack_require__) {
      ...
      vueProgress.prototype = {
        ...
        _setPercentage: function _setPercentage(percentage) {
          ...
          this._textContainer.innerHTML = this._getText(this.getValueFromPercent(percentage), this._item);
        },
        ...
        _generateWrapper: function _generateWrapper() {
          ...
          if (this._styleWrapper) {
            ...
            this._wrapContainer.style.display = 'flex';
          }
          if (this._item.status === 'normal') {
            this._wrapContainer.setAttribute('class', 'color_border');
          } else {
            this._wrapContainer.setAttribute('class', 'white_border');
          }
        ...
        _generateText: function _generateText() {
          ...
          this._textContainer.innerHTML = this._getText(0, this._item);
          return this;
        },

        _getText: function _getText(value, item) {
          ...
          return typeof this._text === 'function' ? this._text.call(this, value, item) : this._text;
        },
        ...
        _generateSvg: function _generateSvg() {
          ...
          this._generatePath(100, false, this._colors[0], this._maxValClass)._generatePath(0, true, this._item.status === 'normal' ? this._colors[1] : 'white', this._valClass);
          if (this._type === 'circle') {
